...
*/
$cakeDescription = 'Trabalho de Sistemas Distribuidos: SWD';
?>
<!DOCTYPE html>
<html>
<head>
...
<header class="row">
    <div class="header-image"><?= $this->Html->image('marvel.studios.jpg') ?></div>
    <div class="header-title"><!--
        <h1>Welcome to CakePHP <?= Configure::version() ?> Red Velvet. Build fast. Grow solid.</h1>
    -->
        <h1> Bem vindo ao sistema de denuncias web, SWD</h1>
    </div>
</header>
...
<div class="row">
    <div class="columns large-12">
        <div class="ctp-warning alert text-center">
            <p>Esse é um trabalho sobre a matéria de Sistemas Paralelos e  Distribuidos, do professor Ricardo Rios</p>
        </div>
